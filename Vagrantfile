...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "collection", primary: true do |srv|
    ...
    sudo -u vagrant bash -c "cd /home/vagrant/ansible_collections/checkmk/general/ && UV_PROJECT_ENVIRONMENT=.venv-vm /home/vagrant/.local/bin/uv sync"
    sudo -u vagrant bash -c "cd /home/vagrant/ansible_collections/checkmk/general/ && UV_PROJECT_ENVIRONMENT=.venv-vm /home/vagrant/.local/bin/uv run ansible-galaxy collection install -f -r /home/vagrant/ansible_collections/checkmk/general/requirements.yml"
