...
DOCUMENTATION = """
    ...
    short_description: Get a list of all roles

    description:
      - Returns a list of all user roles and their configuration,
        including aliases, base roles, and assigned permissions.
...
class LookupModule(LookupBase):
    def run(self, terms, variables, **kwargs):
        ...
        response = json.loads(api.get("/domain-types/user_role/collections/all"))
