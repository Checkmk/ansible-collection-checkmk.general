...
extends_documentation_fragment:
    ...
    - checkmk.general.site_management_options
...
from ansible_collections.checkmk.general.plugins.module_utils.site_management import (
    SiteConnection,
    SiteManagementEndpoints,
    SiteManagementHTTPCodes,
    TargetAPI,
    module_args,
)
