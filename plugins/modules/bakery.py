...
- This module is only available in the Checkmk Enterprise and Managed Editions.
...
notes:
    - The agent bakery is only available in the Checkmk Enterprise and Managed Edition (CEE/CME).
      This module will fail on the Raw Edition (CRE).
