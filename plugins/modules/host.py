...
description:
    ...
    - Hosts can be assigned to folders, given tags and custom attributes, and configured
      as cluster hosts. Changes require an activation step to take effect.
...
notes:
    ...
    - After creating or modifying hosts, you typically need to run the C(checkmk.general.activation)
      module to activate the changes.
