...
- Currently, the idempotency of this module is restricted: To check if an equal rule already exists, only folder, conditions and properties are used. value_raw is currently not being compared. See https://github.com/tribe29/ansible-collection-tribe29.checkmk/issues/186#issuecomment-1396692373
