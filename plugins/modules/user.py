...
- Users can be configured with local or LDAP authentication, assigned roles and
  contact groups, and given personal settings such as language and notification rules.
