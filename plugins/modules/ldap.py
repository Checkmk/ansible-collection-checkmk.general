...
notes:
    - Only keys explicitly provided in I(ldap_config) are compared and potentially updated.
      If you omit a key, its current value will not be changed.
...
msg:
    ...
    type: str
    returned: always
    sample: 'LDAP connection created.'
http_code:
