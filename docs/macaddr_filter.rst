...
.. _ansible_collections.ansible.netcommon.macaddr_filter:
...
- This is a redirect to the :ref:`ansible.utils.macaddr filter plugin <ansible_collections.ansible.utils.macaddr_filter>`.
