...
.. _ansible_collections.ansible.netcommon.nthhost_filter:
...
- This is a redirect to the :ref:`ansible.utils.nthhost filter plugin <ansible_collections.ansible.utils.nthhost_filter>`.
