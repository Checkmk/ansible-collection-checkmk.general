...
When using multiple modules from this collection, you'll often need to provide the same parameters (like `server_url`, `site`, `api_user`, and `api_secret`) repeatedly. Ansible offers several ways to avoid this repetition and keep your playbooks clean.
