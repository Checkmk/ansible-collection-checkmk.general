...
[checkmk.general.data_backend](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/modules/data_backend.py)|Manage the data backend configuration.|[![Integration Tests for Data Backend Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-data_backend.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-data_backend.yaml)
...
[checkmk.general.dcd_telemetry_metrics](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/modules/dcd_telemetry_metrics.py)|Manage DCD connections for telemetry metrics.|[![Integration Tests for DCD Telemetry Metrics Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-dcd_telemetry_metrics.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-dcd_telemetry_metrics.yaml)
