...
Name | Description | Tests
--- | --- | ---
[checkmk.general.activation](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/lookup/activation.py)|Look up the status of a single activation.|[![Integration Tests for Activation Lookup Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-activation.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-activation.yaml)
[checkmk.general.activations](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/lookup/activations.py)|Look up all activations.|[![Integration Tests for Activations Lookup Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-activation.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-activation.yaml)
...
[checkmk.general.downtime](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/lookup/downtime.py)|Look up a single downtime.|[![Integration Tests for Downtime Lookup Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-downtime.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-downtime.yaml)
[checkmk.general.downtimes](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/lookup/downtimes.py)|Look up all downtimes.|[![Integration Tests for Downtimes Lookup Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-downtime.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-downtime.yaml)
...
[checkmk.general.ldap_connection](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/lookup/ldap_connection.py)|Look up LDAP connection attributes.|[![Integration Tests for LDAP Connection Lookup Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-ldap_connection.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-ldap_connection.yaml)
[checkmk.general.ldap_connections](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/lookup/ldap_connections.py)|Look up all LDAP connections.|[![Integration Tests for LDAP Connections Lookup Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-ldap_connection.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-ldap_connection.yaml)
...
[checkmk.general.sites](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/lookup/sites.py)|Look up all sites.|[![Integration Tests for Sites Lookup Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-site.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-lkp-site.yaml)
...
[checkmk.general.aux_tag](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/modules/aux_tag.py)|Manage auxiliary tags.|[![Integration Tests for Aux Tag Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-aux_tag.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-aux_tag.yaml)
...
[checkmk.general.dcd](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/modules/dcd.py)|Manage Dynamic Host Management (DCD).|[![Integration Tests for DCD Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-dcd.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-dcd.yaml)
[checkmk.general.dcd_metricbackend](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/modules/dcd_metricbackend.py)|Manage DCD connections for metric backends.|[![Integration Tests for DCD Metric Backend Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-dcd_metricbackend.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-dcd_metricbackend.yaml)
...
[checkmk.general.ldap](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/modules/ldap.py)|Manage LDAP connections.|[![Integration Tests for LDAP Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-ldap.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-ldap.yaml)
[checkmk.general.notification](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/modules/notification.py)|Manage notification rules.|[![Integration Tests for Notification Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-notification.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-notification.yaml)
[checkmk.general.password](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/modules/password.py)|Manage passwords.|[![Integration Tests for Password Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-password.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-password.yaml)
...
[checkmk.general.metricbackend](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/modules/metricbackend.py)|Manage metric backend connections.|[![Integration Tests for Metric Backend Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-metricbackend.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-metricbackend.yaml)
[checkmk.general.opentelemetry](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/modules/opentelemetry.py)|Manage OpenTelemetry collector configuration.|[![Integration Tests for OpenTelemetry Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-opentelemetry.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-opentelemetry.yaml)
...
[checkmk.general.timeperiod](https://github.com/Checkmk/ansible-collection-checkmk.general/blob/main/plugins/modules/timeperiod.py)|Manage time periods.|[![Integration Tests for Timeperiod Module](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-timeperiod.yaml/badge.svg)](https://github.com/Checkmk/ansible-collection-checkmk.general/actions/workflows/ans-int-test-timeperiod.yaml)
