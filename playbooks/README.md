...
[inventory](./inventory/)|Contains an example configuration for the dynamic inventory plugin for Checkmk (`checkmk.yml`) alongsite a `hosts.ini` for testing purposes.
