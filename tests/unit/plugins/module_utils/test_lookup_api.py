...
class TestProxyURLConstruction:
    ...
    that CheckMKLookupAPI hands its parameters to the shared helper."""
    ...
    def test_proxy_user_without_pass_is_rejected(self):
    ...
    def test_proxy_pass_without_user_is_rejected(self):
        with pytest.raises(ValueError, match="must be provided together"):
            make_api(
                {
                    "proxy_url": "https://proxy.example.com:3128",
